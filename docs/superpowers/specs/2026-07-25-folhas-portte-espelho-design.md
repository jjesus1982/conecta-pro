...
## RESULTADO (25/07) — 6/6 ESPELHADOS + VERIFICADOS ✅
...
| 03/2026 | 51 | R$ 66.860,57 | ✅ **UPDATE in-place** (dif R$182,98 imaterial p/ Jordan): 51 folhas Domínio corrigidas p/ Portte MANTENDO o ID → 46 `payroll_payments` preservados (nada apagado). Deep-check 51/51. |
