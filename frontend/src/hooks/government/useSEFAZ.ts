...
export function useEmitirNFe() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao emitir NF-e');
    },
  });
}
...
export function useCancelarNFe() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao cancelar NF-e');
    },
  });
}
...
export function useEmitirCartaCorrecao() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        msgFromDetail(error?.response?.data?.detail) || 'Erro ao emitir Carta de Correção'
      );
    },
  });
}
...
export function useInutilizarNumeracao() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(
        msgFromDetail(error?.response?.data?.detail) || 'Erro ao inutilizar numeração'
      );
    },
  });
}
...
export function useEmitirCTe() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao emitir CT-e');
    },
  });
}
...
export function useCancelarCTe() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao cancelar CT-e');
    },
  });
}
...
export function useEmitirMDFe() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao emitir MDF-e');
    },
  });
}
...
export function useEncerrarMDFe() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao encerrar MDF-e');
    },
  });
}
...
export function useIncluirCondutor() {
  ...
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao incluir condutor');
    },
  });
}
...
export function useGerarDANFE() {
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao gerar DANFE');
    },
  });
}
...
export function useGerarDANFENFCe() {
  return useMutation({
    ...
    onError: (error: any) => {
      toast.error(msgFromDetail(error?.response?.data?.detail) || 'Erro ao gerar DANFE NFC-e');
    },
  });
}
