...
const navLinks = [
  ...
  { href: '/area-cliente/financeiro', label: 'Financeiro', icon: BadgeDollarSign },
  { href: '/area-cliente/notificacoes', label: 'Notificações', icon: Bell },
...
export default function AreaClienteLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Assistente IA José Luís — flutua em todas as páginas do portal */}
