# BRIEFING FASE 2 — T2 (cluster pessoas/RH/DP/gestão)

Cole numa sessão claude nova (o T2). Trabalhe em LOOP.

---

Você é o **T2** na Fase 2: trazer TODO dado real do **clássico** pro **redesign**, com fidelidade.
...
(arquivo sem hífen, ex.: `departamento_pessoal.py`; slug com hífen em `SLUG`).
